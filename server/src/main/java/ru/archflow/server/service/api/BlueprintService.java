...
import ru.archflow.server.model.dto.blueprint.BlueprintResponse;
import ru.archflow.server.model.entity.enums.BlueprintType;
...
import ru.archflow.server.service.util.MinioService;
...
public class BlueprintService {
    ...
    public void approveBlueprint(Long projectId, Long blueprintId, Long userId) {
        userUtilService.validateProjectRoleAccess(projectId, userId, ProjectRole.OWNER); // Только владелец одобряет
