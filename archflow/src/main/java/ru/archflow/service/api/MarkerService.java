...
import ru.archflow.model.dto.marker.MarkerResponse;
...
public class MarkerService {
    ...
    public MarkerResponse createMarker(Long projectId, Long blueprintId, CreateMarkerRequest request, Long userId) {
        projectService.validateRoleAccess(projectId, userId, ProjectRole.OWNER, ProjectRole.EDITOR, ProjectRole.CONTRIBUTOR);
